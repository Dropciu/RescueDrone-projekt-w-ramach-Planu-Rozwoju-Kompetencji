...
<template>
	...
	aria-label="Sidenav" id="drawer-navigation">
		<div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
			...
			<ul class="space-y-2">
				<li>
					<NuxtLinkLocale to="panel" class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group cursor-pointer">
				...
				<li>
					...
					aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
						...
						<NuxtImg src="/images/icon/drones.svg" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"></NuxtImg>

						<span class="flex-1 ml-3 text-left whitespace-nowrap">
							{{ t('panel.primary.drones')}}
						</span>
					...
					<ul id="dropdown-pages" class="hidden py-2 space-y-2">
						<li>
							<NuxtLinkLocale to="panel-drones" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 cursor-pointer">
								{{ t('panel.primary.overview')}}
							</NuxtLinkLocale>
						</li>

						<li v-for="drone in drones" :key="drone.id">

							<button type="button" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" :aria-controls="'dropdown-pages' + drone.id" :data-collapse-toggle="'dropdown-pages' + drone.id">
						
								<NuxtImg src="/images/icon/drone.svg" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"></NuxtImg>
								
								<NuxtLinkLocale :to="`${ localePath({ name: 'panel-drones' })}/${drone.id}`" class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 cursor-pointer">
									{{ drone.name }}
								</NuxtLinkLocale>
							...
							<ul :id="'dropdown-pages' + drone.id" class="hidden py-2 space-y-2">
								<li>
									<NuxtLinkLocale :to="localePath({ name: 'panel-drones-id-details', params: { id: drone.id} })" class="flex items-center p-2 pl-20 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 cursor-pointer">
										{{ t('panel.primary.details') }}
									</NuxtLinkLocale>
								</li>

								<li>
									<NuxtLinkLocale :to="localePath({ name: 'panel-drones-id-management', params: { id: drone.id} })" class="flex items-center p-2 pl-20 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 cursor-pointer">
										{{ t('panel.primary.management') }}
									</NuxtLinkLocale>
								</li>

								<li>
									<NuxtLinkLocale :to="localePath({ name: 'panel-drones-id-pilot', params: { id: drone.id} })" class="flex items-center p-2 pl-20 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 cursor-pointer">
										{{ t('panel.primary.pilot') }}
									</NuxtLinkLocale>
								</li>
				...
				<li>
					...
					aria-controls="dropdown-sales" data-collapse-toggle="dropdown-sales">
						<svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
						fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
					...
					<ul id="dropdown-sales" class="hidden py-2 space-y-2">
						<li>
							<a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
								{{ t('panel.primary.observe')}}
							</a>
						</li>
						<li>
							<a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
								{{ t('panel.primary.make')}}
							</a>
						</li>
						<li>
							<a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
								{{ t('panel.primary.history')}}
							</a>
						</li>
					</ul>
				</li>
		...
		<div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20">
			...
			id="language-dropdown">
				<ul class="py-1" role="none">
					<li>
						<a @click="setLocale('en')" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:text-white dark:text-gray-300 dark:hover:bg-gray-600"
						role="menuitem">
					...
					<li>
						<a @click="setLocale('de')" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-600"
						role="menuitem">
							<div class="inline-flex items-center">
								<svg aria-hidden="true" class="h-3.5 w-3.5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg"
					...
					<li>
						<a @click="setLocale('it')" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-600"
						role="menuitem">
							<div class="inline-flex items-center">
								<svg aria-hidden="true" class="h-3.5 w-3.5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg"
					...
					<li>
						<a @click="setLocale('jp')" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:text-white dark:text-gray-300 dark:hover:bg-gray-600"
						role="menuitem">
							<div class="inline-flex items-center">
								<svg aria-hidden="true" class="h-3.5 w-3.5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg"
